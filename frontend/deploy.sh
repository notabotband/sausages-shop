...
sudo rm -f /home/front-user/sausage-store.tar.gz
sudo rm -f /home/front-user/frontend
...
sudo cp ./sausage-store.tar.gz /home/front-user/sausage-store.tar.gz #"<...>||true" говорит, если команда обвалится — продолжай#Обновляем конфиг systemd с помощью рестарта
